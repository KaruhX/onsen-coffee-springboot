...
public class SQLConsts {
	...
	public static final String SQL_OBTAIN_CART_PRODUCTS = "SELECT "
			...
			+ "WHERE cart.user_id = ? AND (cart.removed = false OR cart.removed IS NULL)";
	public static final String SQL_VACIAR_CARRITO = "UPDATE cart SET removed = true WHERE user_id = ?";
}